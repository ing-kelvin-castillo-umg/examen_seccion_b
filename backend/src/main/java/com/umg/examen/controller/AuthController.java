...
public class AuthController {
    ...
    @PostMapping("/refresh")
    @Operation(summary = "Renovar access token", description = "Recibe un refresh token válido (no revocado, no expirado) y devuelve un access token nuevo junto con un refresh token rotado")
