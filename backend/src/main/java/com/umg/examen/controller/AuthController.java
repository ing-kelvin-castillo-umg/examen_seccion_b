...
public class AuthController {
    ...
    @PostMapping("/refresh")
    @Operation(summary = "Renovar token de acceso", description = "Genera un nuevo access token (y rota el refresh token) a partir de un refresh token válido y no expirado")
    ...
    @PostMapping("/logout")
    @Operation(summary = "Cerrar sesión", description = "Invalida el refresh token asociado, terminando la sesión activa (usado en logout manual y por inactividad)")
