...
public class AuthController {
    ...
    @PostMapping("/refresh")
    @Operation(summary = "Renovar token de acceso", description = "Emite un nuevo access token a partir de un refresh token válido")
    ...
    @PostMapping("/logout")
    @Operation(summary = "Cerrar sesión", description = "Revoca el refresh token de la sesión de forma idempotente")
