...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 bg-midnight-950 text-slate-100 relative overflow-hidden">
      ...
      {/* Login Card */}
      <div className="w-full max-w-md bg-midnight-900/90 backdrop-blur-xl border border-midnight-700 rounded-3xl p-8 shadow-2xl space-y-6">
        {/* Header */}
        <div className="text-center space-y-2">
          <div className="w-12 h-12 rounded-2xl bg-brand-400 text-midnight-950 flex items-center justify-center mx-auto shadow-lg shadow-brand-500/25">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-brand-400 hover:bg-brand-300 text-midnight-950 font-semibold text-sm shadow-lg shadow-brand-600/30 transition-all hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50"
          >
            {loading ? (
