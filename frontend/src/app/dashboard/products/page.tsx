...
export default function ProductsPage() {
  ...
  return (
    <div className="p-6 sm:p-10 space-y-8 max-w-7xl w-full mx-auto bg-[radial-gradient(circle_at_top_right,rgba(34,211,197,0.10),transparent_32%)]">
      {/* Toast alert */}
      {toast && (
        <div
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-petrol-700 text-xs font-bold uppercase tracking-wider mb-1">
            <Boxes className="w-4 h-4 text-petrol-600" />
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-2.5 rounded-xl border border-petrol-200 bg-white hover:bg-petrol-50 text-petrol-700 transition-colors shadow-sm disabled:opacity-50"
          >
            <RefreshCw className={`w-4 h-4 ${loading ? "animate-spin text-petrol-600" : ""}`} />
          </button>

          <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-white border border-petrol-100 shadow-sm text-xs font-semibold text-navy-700">
            {isAdmin ? (
