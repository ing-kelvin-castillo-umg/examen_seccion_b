    ...
    <div className="p-6 sm:p-10 space-y-8 max-w-7xl w-full mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <h1 className="text-3xl font-black text-midnight-950 tracking-tight">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="p-2.5 rounded-xl border border-brand-200 bg-white hover:bg-brand-50 text-midnight-600 transition-colors shadow-sm disabled:opacity-50"
          >
