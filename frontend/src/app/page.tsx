...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-ivory-100 text-[#172331]">
      <Navbar />
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-16">
        ...
        <section className="text-center space-y-5 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-ivory-200 border border-ivory-300 text-[#657180] text-xs font-semibold tracking-wide">
            <Sparkles className="w-3.5 h-3.5" />
            <span>Universidad Mariano Gálvez de Guatemala • Segundo Parcial</span>
          </div>

          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-[#172331] leading-tight">
          ...
          <p className="text-[#657180] text-base sm:text-lg leading-relaxed">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
            {isAuthenticated ? (
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-steel-500 hover:bg-steel-600 text-white font-semibold text-sm shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5"
              >
              ...
              <>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-ivory-50 hover:bg-ivory-200 text-[#172331] border border-ivory-300 font-medium text-sm transition-all hover:-translate-y-0.5 shadow-sm"
                >
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-[#657180] hidden sm:inline">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
          <div className="p-6 rounded-2xl bg-ivory-50 border border-ivory-200 shadow-sm space-y-3 transition-shadow hover:shadow-md">
            <div className="w-10 h-10 rounded-xl bg-steel-50 text-steel-600 flex items-center justify-center">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold text-[#172331]">Seguridad &amp; Roles JWT</h3>
            <p className="text-xs text-[#657180] leading-relaxed">
              Control de acceso con roles <span className="text-steel-600 font-mono">ROLE_ADMIN</span> y <span className="text-[#657180] font-mono">ROLE_USER</span>. Permisos diferenciados para consulta y mutación de inventario.
            </p>
          </div>

          <div className="p-6 rounded-2xl bg-ivory-50 border border-ivory-200 shadow-sm space-y-3 transition-shadow hover:shadow-md">
            <div className="w-10 h-10 rounded-xl bg-navy-700 text-ivory-50 flex items-center justify-center">
              <Database className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold text-[#172331]">PostgreSQL &amp; Liquibase</h3>
            <p className="text-xs text-[#657180] leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-ivory-50 border border-ivory-200 shadow-sm space-y-3 transition-shadow hover:shadow-md">
            ...
            <h3 className="text-base font-bold text-[#172331]">Arquitectura Limpia y Mappers</h3>
            <p className="text-xs text-[#657180] leading-relaxed">
      ...
      {/* Footer */}
      <footer className="border-t border-ivory-300 py-8 text-center text-xs text-[#657180]">
