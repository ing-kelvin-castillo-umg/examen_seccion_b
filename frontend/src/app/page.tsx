    ...
    <div className="min-h-screen flex flex-col bg-neutral-950 text-neutral-100">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-16">
        ...
        <section className="text-center space-y-5 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary-500/10 border border-primary-500/20 text-primary-300 text-xs font-semibold tracking-wide">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
            {isAuthenticated ? (
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primary-600 hover:bg-primary-500 text-white font-semibold text-sm shadow-lg shadow-primary-600/30 transition-all hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950"
              >
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
          <div className="p-6 rounded-2xl bg-neutral-900/60 border border-neutral-800 space-y-3 transition-colors hover:border-primary-800/60">
          ...
          <div className="p-6 rounded-2xl bg-neutral-900/60 border border-neutral-800 space-y-3 transition-colors hover:border-info-800/60">
          ...
          <div className="p-6 rounded-2xl bg-neutral-900/60 border border-neutral-800 space-y-3 transition-colors hover:border-success-800/60">
