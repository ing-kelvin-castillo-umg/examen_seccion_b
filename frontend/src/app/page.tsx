...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-ink-950 text-ink-50">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
            {isAuthenticated ? (
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-600 hover:bg-brand-700 text-white font-semibold text-sm shadow-lg shadow-brand-600/30 transition-all hover:scale-105"
              >
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
          <div className="p-6 rounded-2xl bg-ink-900/60 border border-ink-800 space-y-3">
            ...
            <p className="text-xs text-ink-300 leading-relaxed">
              Control de acceso con roles <span className="text-brand-200 font-mono">ROLE_ADMIN</span> y <span className="text-emerald-300 font-mono">ROLE_USER</span>. Permisos diferenciados para consulta y mutación de inventario.
            </p>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-ink-800/80 py-8 text-center text-xs text-ink-400">
