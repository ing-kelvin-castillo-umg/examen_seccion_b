    ...
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-16">
        ...
        <section className="text-center space-y-5 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-violet-500/10 border border-violet-500/20 text-violet-400 text-xs font-semibold tracking-wide">
          ...
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-white leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 via-sky-300 to-fuchsia-400">
              Productos
            </span>
          </h1>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
          <div className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800 space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Control de acceso con roles <span className="text-violet-300 font-mono">ROLE_ADMIN</span> y <span className="text-emerald-300 font-mono">ROLE_USER</span>. Permisos diferenciados para consulta y mutación de inventario.
            </p>
          </div>
