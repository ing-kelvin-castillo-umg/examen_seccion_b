...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-midnight-950 text-slate-100">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-16">
        ...
        <section className="text-center space-y-5 max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-white leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-300 via-brand-200 to-coral-300">
              Productos
            </span>
          </h1>
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-4">
            {isAuthenticated ? (
              <Link
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-400 hover:bg-brand-300 text-midnight-950 font-semibold text-sm shadow-lg shadow-brand-600/30 transition-all hover:scale-105"
              >
              ...
              <>
                ...
                <Link
                  href="/login"
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-midnight-900 hover:bg-midnight-800 text-brand-100 border border-midnight-700 font-medium text-sm transition-all"
                >
                  <Code2 className="w-4 h-4" />
                  <span>Acceso seguro al catálogo</span>
                </Link>
              </>
            )}
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold text-white flex items-center gap-2">
                <Zap className="w-5 h-5 text-coral-300" />
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
          <div className="p-6 rounded-2xl bg-midnight-900/75 border border-midnight-700 space-y-3 shadow-xl shadow-black/10">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Control de acceso con roles <span className="text-brand-200 font-mono">ROLE_ADMIN</span> y <span className="text-coral-200 font-mono">ROLE_USER</span>. Permisos diferenciados para consulta y mutación de inventario.
            </p>
          </div>
      ...
      {/* Footer */}
      <footer className="border-t border-midnight-800/80 py-8 text-center text-xs text-midnight-300">
