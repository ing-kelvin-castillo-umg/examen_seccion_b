...
export const ViewProductModal: React.FC<ViewProductModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden border border-petrol-200">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-petrol-100 bg-gradient-to-r from-petrol-50 to-aqua-50">
          <div className="flex items-center gap-2">
            <span className="p-1.5 rounded-lg bg-petrol-100 text-petrol-700">
        ...
        <div className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            <div>
              <span className="text-xs font-semibold text-petrol-700 uppercase tracking-wider">
                {product.category}
              </span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-3.5 rounded-xl bg-petrol-50 border border-petrol-100">
                <span className="text-xs text-petrol-700 font-medium flex items-center gap-1">
                  <DollarSign className="w-3.5 h-3.5" /> Precio Unitario
                </span>
                <p className="text-lg font-bold text-petrol-900 mt-0.5">{product.formattedPrice}</p>
              </div>
...
export const ProductFormModal: React.FC<ProductFormModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-xl bg-white rounded-3xl shadow-2xl overflow-hidden border border-petrol-200">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-petrol-100 bg-gradient-to-r from-petrol-50 to-aqua-50">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-petrol-200 focus:outline-none focus:ring-2 focus:ring-aqua-400 focus:border-transparent text-sm"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-petrol-200 focus:outline-none focus:ring-2 focus:ring-aqua-400 focus:border-transparent text-sm bg-white"
            >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3.5 py-2.5 rounded-xl border border-petrol-200 focus:outline-none focus:ring-2 focus:ring-aqua-400 focus:border-transparent text-sm resize-none"
            />
          </div>
          ...
          <div className="pt-4 border-t border-slate-100 flex items-center justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="inline-flex items-center gap-2 px-5 py-2 text-sm font-bold text-white bg-petrol-700 hover:bg-petrol-600 rounded-xl transition-colors disabled:opacity-50 shadow-sm"
            >
...
export const DeleteConfirmModal: React.FC<DeleteConfirmModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 border border-petrol-200">
