...
export const Carousel: React.FC<CarouselProps> = ({ products, onSelectProduct }) => {
  ...
  return (
    <div
      className="relative w-full overflow-hidden rounded-3xl bg-gradient-to-br from-midnight-950 via-midnight-900 to-brand-900 text-white shadow-2xl shadow-brand-950/30 border border-midnight-700"
    ...
    >
      ...
      <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-coral-500/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative min-h-[420px] sm:min-h-[460px] grid grid-cols-1 lg:grid-cols-12 items-center p-6 sm:p-10 gap-8">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center space-y-4 z-10">
          ...
          <div className="pt-2 flex items-baseline gap-3">
            <span className="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-brand-200 via-brand-300 to-coral-300">
          ...
          {onSelectProduct && (
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-brand-400 to-coral-500 hover:from-brand-300 hover:to-coral-400 text-midnight-950 font-semibold text-sm shadow-lg shadow-brand-500/25 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
