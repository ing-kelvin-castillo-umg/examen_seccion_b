...
export const Carousel: React.FC<CarouselProps> = ({ products, onSelectProduct }) => {
  ...
  return (
    <div
      className="relative w-full overflow-hidden rounded-3xl bg-gradient-to-br from-ink-900 via-ink-800 to-accent-950 text-white shadow-2xl border border-ink-800"
      ...
      <div className="relative min-h-[420px] sm:min-h-[460px] grid grid-cols-1 lg:grid-cols-12 items-center p-6 sm:p-10 gap-8">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center space-y-4 z-10">
          ...
          <div className="pt-2 flex items-baseline gap-3">
            <span className="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-brand-400 via-brand-300 to-accent-300">
