...
export const DataTable: React.FC<DataTableProps> = ({
  ...
  return (
    <div className="w-full bg-white/90 rounded-3xl shadow-xl shadow-midnight-950/5 border border-brand-100 overflow-hidden">
      {/* Table Toolbar */}
      <div className="p-5 border-b border-brand-100 flex flex-col sm:flex-row items-center justify-between gap-4 bg-brand-50/70">
        {/* Search Bar */}
        <div className="relative w-full sm:w-96">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-brand-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition-all"
          />
          {searchTerm && (
            <button
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
          ...
          {isAdmin ? (
            <button
              onClick={onCreate}
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-brand-600 hover:bg-brand-700 text-white text-sm font-semibold shadow-sm shadow-brand-600/20 transition-all hover:shadow"
            >
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm text-slate-600">
          <thead className="bg-midnight-950 text-brand-100 text-xs uppercase font-bold tracking-wider border-b border-midnight-800">
            <tr>
              ...
              filteredProducts.map((product) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-coral-50 text-coral-700 border border-coral-100">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-center">
                    <div className="inline-flex items-center gap-1.5">
                      ...
                      <button
                        ...
                        className="p-2 text-midnight-600 hover:text-brand-700 hover:bg-brand-100 rounded-lg transition-colors"
                      >
                      ...
                      {isAdmin && (
                        ...
                        className="p-2 text-midnight-600 hover:text-coral-600 hover:bg-coral-50 rounded-lg transition-colors"
                        >
